...
hosts=(${REDIS_TRAIN_HOST} ${REDIS_PRE_HOST} ${REDIS_MID_HOST} ${REDIS_CON_HOST} ${REDIS_EXP_HOST})
ports=(${REDIS_TRAIN_PORT} ${REDIS_PRE_PORT} ${REDIS_MID_PORT} ${REDIS_CON_PORT} ${REDIS_EXP_POST})
