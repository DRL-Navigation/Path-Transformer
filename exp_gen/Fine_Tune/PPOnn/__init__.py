...
# network
import torch, numpy
from PPOnn.utils import merge, mlp

from PPOnn.base import Basenn, PreNet
from PPOnn.critic import Critic
from PPOnn.actor import CategoricalActor, Actor, GaussionActor
from PPOnn.RND import RND
from PPOnn.ppo import PPO
from PPOnn.GAIL import GAIL, Discriminator
from PPOnn.nav_encoder import NavPreNet, NavPedPreNet, NavPreNet1D
from PPOnn.atari_encoder import AtariPreNet
from PPOnn.mlp_encoder import MLPPreNet
NETWORK_MAP = {
    "ppo" : PPO,
    "gail": GAIL,
}
...
class ConfigNN:
    ...
    """
    def __init__(self):
        self.ACTION_OUTPUT_DIM = self.ACTIONS_DIM = 2
