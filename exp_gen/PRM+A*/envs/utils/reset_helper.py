...
from envs.utils import ros_utils, prm_astar
...
class EnvPos:
    ...
    def _reset_robot_ped(self):
        ...
        for i in range(self.cfg['robot']['total']):
            ...
            # robot.trajectory = prm_astar.get_global_path(self.init_poses[i], self.target_poses[i], self.obs_range, robo_ped_module_size[i],
            #                                              self.cfg.get("n_samples",10),
            #                                              self.cfg.get("nearset_distance", 3),
            #                                              self.cfg.get("global_map_size", (18, 30)),
            #                                              self.cfg.get("inflation_radius", 0.3))
