...
def get_global_path(start_pose, end_pose, obs_list, shape, *args) -> List[Point]:
    # PRM
    n_sample = args[0]
    ...
    # print(global_path_tuple)
    # 对轨迹里的点转成ros geometry_msgs.msg.Point形式
    global_path_Point = []
    for p in global_path_tuple:
        Point_p = Point()
        Point_p.x, Point_p.y = p[0], p[1]
        global_path_Point.append(Point_p)
    return global_path_Point
