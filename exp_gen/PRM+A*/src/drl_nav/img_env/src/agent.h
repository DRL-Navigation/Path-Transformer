...
public:
    ...
    void set_sub_goal(const Point3d& pose);
    void get_state(vector<double>& state);
    void get_sub_goal(vector<double>& sub_goal);
    ...
    tf::Transform tf_sub_target_world_;
    tf::Transform tf_world_sub_target_;
