...
class ImageEnv(gym.Env):
    ...
    def _get_states(self, robot_states):
        vec_states, sensor_maps, lasers, ped_infos, ped_maps, is_collisions, traj_collisions, is_arrives, distances = [], [], [], [], [], [], [], [], []
        ...
        for i in range(self.robot_total):
            ...
            traj_collisions.append(robot_state.traj_collision)
