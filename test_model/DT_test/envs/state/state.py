...
class ImageState():
    def __init__(self,
        ...
        assert len(vector_states) == len(sensor_maps) == len(is_collisions) == len(traj_collisions) ==len(is_arrives) == len(lasers) \
        ...
        self.traj_collisions = traj_collisions
